...
include::code:MyMathService.java[]
...
include::code:MyCacheManagerConfiguration.java[]
...
include::code:MyCouchbaseCacheManagerConfiguration.java[]
...
include::code:MyRedisCacheManagerConfiguration.java[]
...
include::code:MyCache2kDefaultsConfiguration.java[]
