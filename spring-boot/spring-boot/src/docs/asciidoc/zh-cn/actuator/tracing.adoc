...
----
include::{docs-java}/actuator/micrometertracing/gettingstarted/MyApplication.java[tag=*]
----
...
[source,java,indent=0,subs="verbatim"]
----
include::{docs-java}/actuator/micrometertracing/creatingspans/CustomObservation.java[]
----
