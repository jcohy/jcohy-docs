...
----
include::{docs-java}/appendix/configurationmetadata/annotationprocessor/automaticmetadatageneration/MyServerProperties.java[]
----
...
[source,java,indent=0,subs="verbatim"]
----
include::{docs-java}/appendix/configurationmetadata/annotationprocessor/automaticmetadatageneration/MyMessagingProperties.java[]
----
...
[source,java,indent=0,subs="verbatim"]
----
include::{docs-java}/appendix/configurationmetadata/annotationprocessor/automaticmetadatageneration/nestedproperties/MyServerProperties.java[]
----
