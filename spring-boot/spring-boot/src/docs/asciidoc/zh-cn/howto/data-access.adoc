...
include::code:MyDataSourceConfiguration.java[]
...
include::code:MyDataSourcesConfiguration.java[]
...
include::code:MyCompleteDataSourcesConfiguration.java[]
...
include::code:MyApplication.java[]
...
include::code:MyHibernateConfiguration.java[]
...
include::code:MyHibernateSecondLevelCacheConfiguration.java[]
...
include::code:MyEntityManagerFactoryConfiguration.java[]
...
include::code:OrderConfiguration.java[]

include::code:CustomerConfiguration.java[]
