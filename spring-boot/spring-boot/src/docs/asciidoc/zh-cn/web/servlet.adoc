...
include::code:MyRestController.java[]

"`WebMvc.fn`", 函数方式，将路由配置与请求的实际处理分开，如下例所示:

include::code:MyRoutingConfiguration.java[]

include::code:MyUserHandler.java[]
...
include::code:MyHttpMessageConvertersConfiguration.java[]
...
include::code:MyControllerAdvice.java[]
...
include::code:MyController.java[]
...
include::code:MyErrorViewResolver.java[]
...
include::code:MyErrorPagesConfiguration.java[]
...
include::code:MyFilterConfiguration.java[]
...
include::code:MyCorsConfiguration.java[]
...
include::code:MyJerseyConfig.java[]
...
include::code:MySameSiteConfiguration.java[]
...
include::code:MyWebServerFactoryCustomizer.java[]
...
include::code:MyTomcatWebServerFactoryCustomizer.java[]
