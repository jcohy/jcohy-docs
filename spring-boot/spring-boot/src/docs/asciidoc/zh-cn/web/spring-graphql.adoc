...
include::code:GreetingController.java[tag=*]
...
include::code:RSocketGraphQlClientExample.java[tag=builder]

然后发送请求:

include::code:RSocketGraphQlClientExample.java[tag=request]
