...
----
include::{docs-java}/features/json/jackson/customserializersanddeserializers/MyJsonComponent.java[]
----
...
[source,java,indent=0,subs="verbatim"]
----
include::{docs-java}/features/json/jackson/customserializersanddeserializers/object/MyJsonComponent.java[]
----
