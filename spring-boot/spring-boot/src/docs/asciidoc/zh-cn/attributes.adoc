...
:docs-java: {sources-root}/main/java/org/springframework/boot/docs
:docs-kotlin: {sources-root}/main/kotlin/org/springframework/boot/docs
:docs-groovy: {sources-root}/main/groovy/org/springframework/boot/docs
...
:spring-framework-docs: https://docs.jcohy.com/docs/spring-framework/{spring-framework-version}/html5/zh-cn/
