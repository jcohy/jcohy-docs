:revnumber: {spring-boot-version}
:revdate: {localdate}

:spring-boot-artifactory-repo: release
:github-tag: v2.2.8.RELEASE
...
:spring-framework-docs: http://docs.jcohy.com/docs/spring-framework/{spring-framework-version}/html5/zh-cn/
