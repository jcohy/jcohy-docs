...
|[[application-properties.data.spring.mongodb.embedded.features]]<<application-properties.data.spring.mongodb.embedded.features,`+spring.mongodb.embedded.features+`>>
