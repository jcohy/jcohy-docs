...
== 系统要求
Spring Boot {spring-boot-version} 需要 https://www.java.com[Java 8] 并且与 Java 15 (包括) 兼容.  还需要 {spring-framework-docs}/[Spring Framework {spring-framework-version}]  或更高版本.
