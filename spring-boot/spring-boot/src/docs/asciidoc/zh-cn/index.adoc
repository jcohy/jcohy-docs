...
本文档包含 https://docs.jcohy.com/docs/spring-boot/{spring-boot-version}/html5/zh-cn/index.html[一个多页面] 和 https://docs.jcohy.com/docs/spring-boot/{spring-boot-version}/pdf/zh-cn/index.pdf[一个 PDF].
endif::[]
ifdef::backend-spring-pdf[]
本文档包含 https://docs.jcohy.com/docs/spring-boot/{spring-boot-version}/htmlsingle/zh-cn/index.html[一个单页面] 和 https://docs.jcohy.com/docs/spring-boot/{spring-boot-version}/html5/zh-cn/index.html[多页面].
endif::[]
