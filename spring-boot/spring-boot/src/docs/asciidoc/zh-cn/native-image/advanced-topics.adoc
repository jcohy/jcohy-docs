...
----
include::{docs-java}/nativeimage/advanced/nestedconfigurationproperties/MyProperties.java[]
----
...
[source,java,indent=0,subs="verbatim"]
----
include::{docs-java}/nativeimage/advanced/nestedconfigurationproperties/Nested.java[]
----
...
[source,java,indent=0,subs="verbatim"]
----
include::{docs-java}/nativeimage/advanced/nestedconfigurationproperties/MyPropertiesCtor.java[]
----
...
[source,java,indent=0,subs="verbatim"]
----
include::{docs-java}/nativeimage/advanced/nestedconfigurationproperties/MyPropertiesRecord.java[]
----
...
----
include::{docs-kotlin}/nativeimage/advanced/nestedconfigurationproperties/MyPropertiesKotlin.kt[]
----
...
[source,java,indent=0,subs="verbatim"]
----
include::{docs-java}/nativeimage/advanced/customhints/MyRuntimeHints.java[]
----
...
[source,java,indent=0,subs="verbatim"]
----
include::{docs-java}/nativeimage/advanced/customhints/testing/MyRuntimeHintsTests.java[]
----
