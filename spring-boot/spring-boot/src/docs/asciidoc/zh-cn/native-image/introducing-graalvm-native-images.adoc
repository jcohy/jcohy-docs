...
----
include::{docs-java}/nativeimage/introducinggraalvmnativeimages/understandingaotprocessing/sourcecodegeneration/MyConfiguration.java[]
----
...
[source,java,indent=0,subs="verbatim"]
----
include::{docs-java}/nativeimage/introducinggraalvmnativeimages/understandingaotprocessing/sourcecodegeneration/MyConfiguration__BeanDefinitions.java[]
----
