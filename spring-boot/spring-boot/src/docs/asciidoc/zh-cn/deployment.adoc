...
App Engine Standard 要求您使用WAR包装.  请按照 https://github.com/GoogleCloudPlatform/java-docs-samples/tree/master/appengine-java8/springboot-helloworld/README.md[以下步骤] 将 App Engine标准应用程序部署到Google Cloud.
