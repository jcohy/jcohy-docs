...
image::{image-resource}/multitenancy/multitenacy_database.png[]
...
image::{image-resource}/multitenancy/multitenacy_schema.png[]
...
image::{image-resource}/multitenancy/multitenacy_discriminator.png[]
