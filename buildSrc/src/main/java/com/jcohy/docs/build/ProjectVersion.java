...
public enum ProjectVersion {
    ...
    SPRING_FRAMEWORK("spring-framework","spring-framework-version","5.3.19",""),
    SPRING_HATEOAS("spring-hateoas","spring-hateoas-version","1.4.2",""),
    SPRING_SECURITY("spring-security","spring-security-version","5.6.3",""),
    ...
    SPRING_DATA_R2DBC("spring-data-r2dbc","spring-data-r2dbc-version","1.4.4",""),
//  SPRING_DATA_SOLR("spring-data-solr","spring-data-solr-version","4.3.8",""),
    SPRING_DATA_ELASTICSEARCH("spring-data-elasticsearch","spring-data-elasticsearch-version","4.3.4",""),
    SPRING_DATA_JPA("spring-data-jpa","spring-data-jpa-version","2.6.4",""),
    SPRING_DATA_REDIS("spring-data-redis","spring-data-redis-version","2.6.4",""),
    SPRING_DATA_NEO4J("spring-data-neo4j","spring-data-neo4j-version","6.2.4","https://docs.spring.io/spring-data/neo4j/docs/6.2.4/reference/html/"),
    SPRING_DATA_REST("spring-data-rest","spring-data-rest-version","3.6.4",""),
