...
public enum ProjectVersion {
    ...
    REACTIVE_SPRING("reactive-spring","reactive-spring-version","1.0.0",""),
    ...
    SPRING_AMQP("spring-amqp","spring-amqp-version","3.0.0","https://docs.spring.io/spring-amqp/docs/3.0.0/reference/html/"),
    SPRING_BATCH("spring-batch","spring-batch-version","5.0.0","https://docs.spring.io/spring-batch/docs/5.0.0/reference/html/"),
    ...
    SPRING_INTEGRATION("spring-integration","spring-integration-version","6.0.0","https://docs.spring.io/spring-integration/docs/6.0.0/reference/html/"),
    SPRING_KAFKA("spring-kafka","spring-kafka-version","3.0.0","https://docs.spring.io/spring-kafka/docs/3.0.0/reference/html/"),
    ...
    SPRING_DATA_COUCHBASE("spring-data-couchbase","spring-data-couchbase-version","5.0.0","https://docs.spring.io/spring-data/couchbase/docs/5.0.0/reference/html/"),
    ...
    SPRING_DATA_MONGODB("spring-data-mongodb","spring-data-mongodb-version","4.0.0","https://docs.spring.io/spring-data/mongodb/docs/4.0.0/reference/html/"),
    SPRING_DATA_NEO4J("spring-data-neo4j","spring-data-neo4j-version","7.0.0","https://docs.spring.io/spring-data/neo4j/docs/7.0.0/reference/html/"),
