...
image::{image-dir}/ant-task-migration.png[]
...
====
include::{snippets-dir}/antMigration/importBuild/groovy/build.gradle[tags=apply-plugin]
include::{snippets-dir}/antMigration/importBuild/kotlin/build.gradle.kts[tags=apply-plugin]
====
...
====
include::{snippets-dir}/antMigration/importBuild/groovy/build.gradle[tags=import-build]
include::{snippets-dir}/antMigration/importBuild/kotlin/build.gradle.kts[tags=import-build]
====
...
====
include::{snippets-dir}/antMigration/importBuild/groovy/build.gradle[tags=source-sets]
include::{snippets-dir}/antMigration/importBuild/kotlin/build.gradle.kts[tags=source-sets]
====
...
====
include::{snippets-dir}/antMigration/importBuild/groovy/build.gradle[tags=task-dependencies]
include::{snippets-dir}/antMigration/importBuild/kotlin/build.gradle.kts[tags=task-dependencies]
====
...
====
include::{snippets-dir}/antMigration/fileDeps/groovy/build.gradle[tags=file-deps]
include::{snippets-dir}/antMigration/fileDeps/kotlin/build.gradle.kts[tags=file-deps]
====
...
====
include::{snippets-dir}/antMigration/fileDeps/groovy/build.gradle[tags=retrieve-deps]
include::{snippets-dir}/antMigration/fileDeps/kotlin/build.gradle.kts[tags=retrieve-deps]
====
+
...
====
include::{snippets-dir}/antMigration/fileDeps/groovy/build.gradle[tags=properties]
include::{snippets-dir}/antMigration/fileDeps/kotlin/build.gradle.kts[tags=properties]
====
...
+
====
include::{snippets-dir}/antMigration/multiProject/groovy/web/build.xml[tags=build-required]
====
...
+
====
include::{snippets-dir}/antMigration/multiProject/groovy/web/build.gradle[]
include::{snippets-dir}/antMigration/multiProject/kotlin/web/build.gradle.kts[]
====
+
