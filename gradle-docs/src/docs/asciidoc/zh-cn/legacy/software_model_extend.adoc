...
.build.gradle
----
include::{snippets-dir}/customModel/languageType/groovy/build.gradle[tag=build-script]
----
...
----
include::{snippets-dir}/customModel/languageType/groovy/buildSrc/src/main/groovy/sample/documentation/DocumentationComponent.groovy[tag=component-declaration]
----
...
----
include::{snippets-dir}/customModel/languageType/groovy/buildSrc/src/main/groovy/sample/documentation/DocumentationPlugin.groovy[tag=component-registration]
----
...
----
include::{snippets-dir}/customModel/languageType/groovy/buildSrc/src/main/groovy/sample/documentation/DocumentationBinary.groovy[tag=binary-declaration]
----
...
.DocumentationPlugin.groovy
----
include::{snippets-dir}/customModel/languageType/groovy/buildSrc/src/main/groovy/sample/documentation/DocumentationPlugin.groovy[tag=binary-registration]
----
...
----
include::{snippets-dir}/customModel/languageType/groovy/buildSrc/src/main/groovy/sample/markdown/MarkdownSourceSet.groovy[tag=markdown-lang-declaration]
----
...
----
include::{snippets-dir}/customModel/languageType/groovy/buildSrc/src/main/groovy/sample/markdown/MarkdownPlugin.groovy[tag=markdown-lang-registration]
----
...
.DocumentationPlugin.groovy
----
include::{snippets-dir}/customModel/languageType/groovy/buildSrc/src/main/groovy/sample/documentation/DocumentationPlugin.groovy[tag=binaries-generation]
----
...
.DocumentationPlugin.groovy
----
include::{snippets-dir}/customModel/languageType/groovy/buildSrc/src/main/groovy/sample/documentation/DocumentationPlugin.groovy[tag=text-tasks-generation]
----
...
.MarkdownPlugin.groovy
----
include::{snippets-dir}/customModel/languageType/groovy/buildSrc/src/main/groovy/sample/markdown/MarkdownPlugin.groovy[tag=markdown-tasks-generation]
----
...
.**`gradle -q components`** 的输出
----
> gradle -q components
include::{snippets-dir}/customModel/languageType/tests/softwareModelExtend-components.out[]
----
...
.build.gradle
----
include::{snippets-dir}/customModel/internalViews/groovy/build.gradle[tag=type-declaration]
----
...
.build.gradle
----
include::{snippets-dir}/customModel/internalViews/groovy/build.gradle[tag=type-registration]
----
...
.build.gradle
----
include::{snippets-dir}/customModel/internalViews/groovy/build.gradle[tag=internal-view-mutation]
----
...
.build.gradle
----
include::{snippets-dir}/customModel/internalViews/groovy/build.gradle[tag=build-script]
----

.`gradle -q model` 的输出
----
> gradle -q model
include::{snippets-dir}/customModel/internalViews/tests/softwareModelExtend-iv-model.out[]
----
