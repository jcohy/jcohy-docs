...
.build.gradle
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=managed-type-and-plugin]
----

.**`gradle hello`** 的输出
----
> gradle hello
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/tests/basicRuleSourcePlugin-all.out[]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=create-rule]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=plugin-mutate-rule]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=task-create-rule]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=managed-type]
----
...
[source,groovy,indent=0]
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-string]
----
...
[source,groovy,indent=0]
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-file]
----
...
[source,groovy,indent=0]
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-long]
----
...
[source,groovy,indent=0]
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-boolean]
----
...
[source,groovy,indent=0]
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-int]
----
...
[source,groovy,indent=0]
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-managed]
----
...
[source,groovy,indent=0]
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-enum]
----
...
[source,groovy,indent=0]
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-managedset]
----
...
[source,groovy,indent=0]
----
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-collection-scalar]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/ruleSourcePluginEach/groovy/build.gradle[]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/modelDsl/groovy/build.gradle[tag=configure-rule]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/configureAsRequired/groovy/build.gradle[tag=configure-rule]
----

.**`gradle showPerson`** 的输出
----
> gradle showPerson
include::{snippets-dir}/modelRules/configureAsRequired/tests/modelDslConfigureRuleRunWhenRequired.out[]
----
...
.**`gradle somethingElse`** 的输出
----
> gradle somethingElse
include::{snippets-dir}/modelRules/configureAsRequired/tests/modelDslConfigureRuleNotRunWhenNotRequired.out[]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/modelDsl/groovy/build.gradle[tag=create-rule]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/modelDsl/groovy/build.gradle[tag=create-rule-no-config]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/initializationRuleRunsBeforeConfigurationRules/groovy/build.gradle[tag=configure-and-create-rules]
----

.**`gradle showPerson`** 的输出
----
> gradle showPerson
include::{snippets-dir}/modelRules/initializationRuleRunsBeforeConfigurationRules/tests/modelDslInitializationRuleRunsBeforeConfigurationRule.out[]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/modelDsl/groovy/build.gradle[tag=model-map-nested-create-rule]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/modelDsl/groovy/build.gradle[tag=model-map-nested-configure-rule]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/configureElementsOfMap/groovy/build.gradle[tag=create-and-configure]
----

.**`gradle listPeople`** 的输出
----
> gradle listPeople
include::{snippets-dir}/modelRules/configureElementsOfMap/tests/modelDslModelMapNestedAll.out[]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/modelDsl/groovy/build.gradle[tag=managed-type-nested-config-rule]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/modelDslCoercion/groovy/build.gradle[]
----
...
.build.gradle
----
include::{snippets-dir}/modelRules/modelDsl/groovy/build.gradle[tag=rule-inputs]
----
...
----
> gradle model
include::{snippets-dir}/modelRules/basicRuleSourcePlugin/tests/basicRuleSourcePlugin-model-task.out[]
----
