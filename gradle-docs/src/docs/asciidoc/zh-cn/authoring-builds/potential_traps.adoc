...
.scope.groovy
----
include::{snippets-dir}/tutorial/groovyScope/groovy/src/main/groovy/scope.groovy[]
----

.`groovy scope.groovy` 的输出
----
> groovy scope.groovy
include::{snippets-dir}/tutorial/groovyScope/tests/scope.out[]
----
...
====
include::{snippets-dir}/tutorial/mkdirTrap/groovy/build.gradle[]
include::{snippets-dir}/tutorial/mkdirTrap/kotlin/build.gradle.kts[]
====

.**`gradle -q compile`** 的输出
----
> gradle -q compile
include::{snippets-dir}/tutorial/mkdirTrap/tests/mkdirTrap.out[]
----
