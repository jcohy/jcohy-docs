...
,领域对象 (例如 link:{groovyDslPath}/org.gradle.api.tasks.SourceSet.html[SourceSet]) ,约定 (例如 Java source 位于 `src/main/java`) ,以及扩展核心对象和其他插件的对象.
...
解析插件意味着找到包含给定插件的 jar 的正确版本,并将其添加为脚本类路径. 插件解决后,即可在构建脚本中使用其 API. 脚本插件是自解析的,因为它们是从应用它们时提供的特定文件路径或 URL 解析的.
...
如果要  使用变体定义插件版本,请参见 <<#sec:plugin_version_management,插件版本管理>>.
...
.仅在某些子项目上应用插件
====
include::{snippets-dir}/plugins/multiproject/groovy/settings.gradle[tags=include-subprojects]
include::{snippets-dir}/plugins/multiproject/groovy/build.gradle[tags=plugins-on-subprojects]
include::{snippets-dir}/plugins/multiproject/groovy/hello-a/build.gradle[]
include::{snippets-dir}/plugins/multiproject/groovy/hello-b/build.gradle[]
include::{snippets-dir}/plugins/multiproject/groovy/goodbye-c/build.gradle[]
include::{snippets-dir}/plugins/multiproject/kotlin/settings.gradle.kts[tags=include-subprojects]
include::{snippets-dir}/plugins/multiproject/kotlin/build.gradle.kts[tags=plugins-on-subprojects]
include::{snippets-dir}/plugins/multiproject/kotlin/hello-a/build.gradle.kts[]
include::{snippets-dir}/plugins/multiproject/kotlin/hello-b/build.gradle.kts[]
include::{snippets-dir}/plugins/multiproject/kotlin/goodbye-c/build.gradle.kts[]
====
...
====
include::{snippets-dir}/plugins/consuming/groovy/settings.gradle[tags=custom-plugin-repositories]
include::{snippets-dir}/plugins/consuming/kotlin/settings.gradle.kts[tags=custom-plugin-repositories]
====
...
====
include::{snippets-dir}/plugins/pluginVersions/groovy/settings.gradle[tags=configure-plugin-version]
include::{snippets-dir}/plugins/pluginVersions/groovy/build.gradle[]
include::{snippets-dir}/plugins/pluginVersions/groovy/gradle.properties[]
include::{snippets-dir}/plugins/pluginVersions/kotlin/settings.gradle.kts[tags=configure-plugin-version]
include::{snippets-dir}/plugins/pluginVersions/kotlin/build.gradle.kts[]
include::{snippets-dir}/plugins/pluginVersions/kotlin/gradle.properties[]
====
...
====
include::{snippets-dir}/plugins/resolutionRules/groovy/settings.gradle[tags=plugin-resolution-strategy]
include::{snippets-dir}/plugins/resolutionRules/kotlin/settings.gradle.kts[tags=plugin-resolution-strategy]
====
...
在示例目录中运行 `gradle publish`  会创建以下 Maven 存储库:

image::{image-dir}/plugin-markers.png[]
