...
====
include::{snippets-dir}/buildlifecycle/basic/groovy/settings.gradle[];build.gradle[]
include::{snippets-dir}/buildlifecycle/basic/kotlin/settings.gradle.kts[];build.gradle.kts[]
====
...
====
include::{snippets-dir}/buildlifecycle/projectEvaluateEvents/groovy/build.gradle[tags=after-evaluate];project-a.gradle[]
include::{snippets-dir}/buildlifecycle/projectEvaluateEvents/kotlin/build.gradle.kts[tags=after-evaluate];project-a.gradle.kts[]
====
