...
.WebServer.java
----
include::{snippets-dir}/plugins/buildService/groovy/buildSrc/src/main/java/WebServer.java[]
----
====
...
.Download.java
----
include::{snippets-dir}/plugins/buildService/groovy/buildSrc/src/main/java/Download.java[]
----
====
...
.DownloadPlugin.java
----
include::{snippets-dir}/plugins/buildService/groovy/buildSrc/src/main/java/DownloadPlugin.java[]
----
====
