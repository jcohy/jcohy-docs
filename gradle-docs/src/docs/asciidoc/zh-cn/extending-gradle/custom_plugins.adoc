...
====
include::{snippets-dir}/plugins/customPlugin/groovy/consumer/settings.gradle[tags=use-plugin];build.gradle[tags=use-plugin]
include::{snippets-dir}/plugins/customPlugin/kotlin/consumer/settings.gradle.kts[tags=use-plugin];build.gradle.kts[tags=use-plugin]
====
...
----
include::{snippetsPath}/plugins/customPlugin/groovy/plugin/src/test/java/org/gradle/GreetingPluginTest.java[tag=test-plugin]
----
...
----
include::{snippetsPath}/plugins/customPlugin/groovy/plugin/src/main/resources/META-INF/gradle-plugins/org.samples.greeting.properties[]
----
