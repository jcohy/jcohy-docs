...
====
include::{snippets-dir}/testing/jacoco-quickstart/groovy/build.gradle[tags=apply-plugin]
include::{snippets-dir}/testing/jacoco-quickstart/kotlin/build.gradle.kts[tags=apply-plugin]
====
...
====
include::{snippets-dir}/testing/jacoco-quickstart/groovy/build.gradle[tags=testtask-dependency]
include::{snippets-dir}/testing/jacoco-quickstart/kotlin/build.gradle.kts[tags=testtask-dependency]
====
...
====
include::{snippets-dir}/testing/jacoco-quickstart/groovy/build.gradle[tags=jacoco-configuration]
include::{snippets-dir}/testing/jacoco-quickstart/kotlin/build.gradle.kts[tags=jacoco-configuration]
====
...
====
include::{snippets-dir}/testing/jacoco-quickstart/groovy/build.gradle[tags=report-configuration]
include::{snippets-dir}/testing/jacoco-quickstart/kotlin/build.gradle.kts[tags=report-configuration]
====
image::{image-dir}/jacocoHtmlReport.png[JaCoCo HTML report,903,277]
...
====
include::{snippets-dir}/testing/jacoco-quickstart/groovy/build.gradle[tags=violation-rules-configuration]
include::{snippets-dir}/testing/jacoco-quickstart/kotlin/build.gradle.kts[tags=violation-rules-configuration]
====
...
.Configuring test task
====
include::{snippets-dir}/testing/jacoco-quickstart/groovy/build.gradle[tags=testtask-configuration]
include::{snippets-dir}/testing/jacoco-quickstart/kotlin/build.gradle.kts[tags=testtask-configuration]
====
...
====
include::{snippets-dir}/testing/jacoco-quickstart/groovy/build.gradle[tags=testtask-configuration-defaults]
include::{snippets-dir}/testing/jacoco-quickstart/kotlin/build.gradle.kts[tags=testtask-configuration-defaults]
====
...
====
include::{snippets-dir}/testing/jacoco-application/groovy/build.gradle[tags=application-configuration]
include::{snippets-dir}/testing/jacoco-application/kotlin/build.gradle.kts[tags=application-configuration]
====
