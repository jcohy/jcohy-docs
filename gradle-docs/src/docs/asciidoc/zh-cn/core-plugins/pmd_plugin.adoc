...
====
include::{snippets-dir}/codeQuality/codeQuality/groovy/build.gradle[tags=use-pmd-plugin]
include::{snippets-dir}/codeQuality/codeQuality/kotlin/build.gradle.kts[tags=use-pmd-plugin]
====
...
====
include::{snippets-dir}/codeQuality/codeQuality/groovy/build.gradle[tags=customize-pmd]
include::{snippets-dir}/codeQuality/codeQuality/kotlin/build.gradle.kts[tags=customize-pmd]
====
