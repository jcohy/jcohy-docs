...
====
include::{snippets-dir}/base/basePlugin/groovy/build.gradle[tags=apply-base-plugin]
include::{snippets-dir}/base/basePlugin/kotlin/build.gradle.kts[tags=apply-base-plugin]
====
...
The Base Plugin adds no <<declaring_dependencies.adoc#sec:what-are-dependency-configurations,configurations for dependencies>>, but it does add the following configurations for <<artifact_management.adoc#sec:artifacts_and_configurations,artifacts>>:
