...
====
include::{snippets-dir}/codeQuality/codeQuality/groovy/build.gradle[tags=use-codenarc-plugin]
include::{snippets-dir}/codeQuality/codeQuality/kotlin/build.gradle.kts[tags=use-codenarc-plugin]
====
