...
====
include::{snippets-dir}/ear/earWithWar/groovy/build.gradle[tags=use-ear-plugin]
include::{snippets-dir}/ear/earWithWar/kotlin/build.gradle.kts[tags=use-ear-plugin]
====
...
====
include::{snippets-dir}/ear/earCustomized/groovy/ear/build.gradle[]
include::{snippets-dir}/ear/earCustomized/kotlin/ear/build.gradle.kts[]
====
