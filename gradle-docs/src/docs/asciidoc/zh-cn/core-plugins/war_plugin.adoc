...
====
include::{snippets-dir}/webApplication/quickstart/groovy/build.gradle[tags=use-war-plugin]
include::{snippets-dir}/webApplication/quickstart/kotlin/build.gradle.kts[tags=use-war-plugin]
====
...
.War plugin - tasks
image::{image-dir}/warPluginTasks.png[]
...
====
include::{snippets-dir}/webApplication/customized/groovy/build.gradle[tags=customization]
include::{snippets-dir}/webApplication/customized/kotlin/build.gradle.kts[tags=customization]
====
