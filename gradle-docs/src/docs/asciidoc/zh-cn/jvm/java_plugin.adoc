...
====
include::{snippets-dir}/java/quickstart/groovy/build.gradle[tags=use-plugin]
include::{snippets-dir}/java/quickstart/kotlin/build.gradle.kts[tags=use-plugin]
====
...
.Java plugin - tasks
image::{image-dir}/javaPluginTasks.png[]
...
====
include::{snippets-dir}/java/customizedLayout/groovy/build.gradle[tags=define-main]
include::{snippets-dir}/java/customizedLayout/kotlin/build.gradle.kts[tags=define-main]
====
...
====
include::{snippets-dir}/java/sourceSets/groovy/build.gradle[tags=jar]
include::{snippets-dir}/java/sourceSets/kotlin/build.gradle.kts[tags=jar]
====
...
====
include::{snippets-dir}/java/sourceSets/groovy/build.gradle[tags=javadoc]
include::{snippets-dir}/java/sourceSets/kotlin/build.gradle.kts[tags=javadoc]
====
...
====
include::{snippets-dir}/java/sourceSets/groovy/build.gradle[tags=test]
include::{snippets-dir}/java/sourceSets/kotlin/build.gradle.kts[tags=test]
====
...
image::{image-dir}/java-main-configurations.png[]

.Java plugin - _test_ source set dependency configurations
image::{image-dir}/java-test-configurations.png[]
...
====
include::{snippets-dir}/java/basic/groovy/build.gradle[tags=java-extension]
include::{snippets-dir}/java/basic/kotlin/build.gradle.kts[tags=java-extension]
====
...
----
include::{snippets-dir}/java/incrementalAnnotationProcessing/groovy/processor/src/main/resources/META-INF/gradle/incremental.annotation.processors[tag=registering-incremental-annotation-processors]
----
...
----
include::{snippets-dir}/java/incrementalAnnotationProcessing/groovy/processor/src/main/java/org/gradle/ServiceRegistryProcessor.java[tag=options-of-dynamic-processor]
----
...
----
include::{snippets-dir}/java/incrementalAnnotationProcessing/groovy/processor/src/main/java/org/gradle/EntityProcessor.java[tag=isolating-annotation-processor]
----
...
.processor/src/main/java/org/gradle/ServiceRegistryProcessor.java
----
include::{snippets-dir}/java/incrementalAnnotationProcessing/groovy/processor/src/main/java/org/gradle/ServiceRegistryProcessor.java[tag=aggregating-annotation-processor]
----
...
====
include::{snippets-dir}/java/apt/groovy/build.gradle[tags=annotation-processing]
include::{snippets-dir}/java/apt/kotlin/build.gradle.kts[tags=annotation-processing]
====
