...
====
include::{snippets-dir}/java-library/quickstart/groovy/build.gradle[tags=use-plugin]
include::{snippets-dir}/java-library/quickstart/kotlin/build.gradle.kts[tags=use-plugin]
====
...
====
include::{snippets-dir}/java-library/quickstart/groovy/build.gradle[tags=dependencies]
include::{snippets-dir}/java-library/quickstart/kotlin/build.gradle.kts[tags=dependencies]
====
...
----
include::{snippets-dir}/java-library/quickstart/groovy/src/main/java/org/gradle/HttpClientWrapper.java[tag=sample]
----
...
image::{image-dir}/java-library-ignore-deprecated-main.png[]
...
image::{image-dir}/java-library-ignore-deprecated-test.png[]
...
----
include::{snippets-dir}/java-library/module/groovy/src/main/java/module-info.java[]
----
...
====
include::{snippets-dir}/java-library/module/groovy/build.gradle[tags=inferModulePath]
include::{snippets-dir}/java-library/module/kotlin/build.gradle.kts[tags=inferModulePath]
====
...
====
include::{snippets-dir}/java-library/module/groovy/build.gradle[tags=declareVersion]
include::{snippets-dir}/java-library/module/kotlin/build.gradle.kts[tags=declareVersion]
====
...
====
include::{snippets-dir}/java-library/module/groovy/build.gradle[tags=dependencies]
include::{snippets-dir}/java-library/module/kotlin/build.gradle.kts[tags=dependencies]
====

[source,java,indent=0]
.Module dependencies declared in module-info.java file
----
include::{snippets-dir}/java-library/module/kotlin/src/main/java/module-info.java[]
----
...
====
include::{snippets-dir}/java-library/module/groovy/build.gradle[tags=automaticModuleName]
include::{snippets-dir}/java-library/module/kotlin/build.gradle.kts[tags=automaticModuleName]
====
