...
====
include::{snippets-dir}/buildCache/caching-android-projects/groovy/build.gradle[tags=cacheKapt]
include::{snippets-dir}/buildCache/caching-android-projects/kotlin/build.gradle.kts[tags=cacheKapt]
====
