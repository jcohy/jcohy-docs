...
====
include::{snippets-dir}/buildCache/integration-tests/groovy/build.gradle[tags=environment]
include::{snippets-dir}/buildCache/integration-tests/kotlin/build.gradle.kts[tags=environment]
====
...
====
include::{snippets-dir}/buildCache/conditional-action/groovy/build.gradle[tags=conditionalAction]
include::{snippets-dir}/buildCache/conditional-action/kotlin/build.gradle.kts[tags=conditionalAction]
====

You should always add the action unconditionally:

====
include::{snippets-dir}/buildCache/conditional-action/groovy/build.gradle[tags=unconditionalAction]
include::{snippets-dir}/buildCache/conditional-action/kotlin/build.gradle.kts[tags=unconditionalAction]
====
...
====
include::{snippets-dir}/buildCache/java-version-tracking/groovy/build.gradle[tags=trackVendor]
include::{snippets-dir}/buildCache/java-version-tracking/kotlin/build.gradle.kts[tags=trackVendor]
====
...
====
include::{snippets-dir}/buildCache/custom-action/groovy/build.gradle[tags=customAction]
include::{snippets-dir}/buildCache/custom-action/kotlin/build.gradle.kts[tags=customAction]
====

do

====
include::{snippets-dir}/buildCache/configure-task/groovy/build.gradle[tags=configureTask]
include::{snippets-dir}/buildCache/configure-task/kotlin/build.gradle.kts[tags=configureTask]
====
...
====
include::{snippets-dir}/buildCache/reproducible-archives/groovy/build.gradle[]
include::{snippets-dir}/buildCache/reproducible-archives/kotlin/build.gradle.kts[]
====
