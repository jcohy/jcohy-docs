...
====
include::{snippets-dir}/buildCache/timestamp-in-manifest/groovy/build.gradle[tags=timestamp]
include::{snippets-dir}/buildCache/timestamp-in-manifest/kotlin/build.gradle.kts[tags=timestamp]
====
...
====
include::{snippets-dir}/buildCache/normalization/groovy/build.gradle[tags=normalization]
include::{snippets-dir}/buildCache/normalization/kotlin/build.gradle.kts[tags=normalization]
====
