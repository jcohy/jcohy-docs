...
.build.gradle
----
include::{snippets-dir}/native-binaries/c/groovy/build.gradle[tag=libraries]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/c/groovy/build.gradle[tag=executables]
----
...
image::{image-dir}/nativeDependents.png[]
...
.build.gradle
----
include::{snippets-dir}/native-binaries/cunit/groovy/build.gradle[tag=terse-example]
----
...
include::{snippets-dir}/native-binaries/cunit/tests/dependentComponentsReport.out[]
----
...
include::{snippets-dir}/native-binaries/cunit/tests/dependentComponentsReportAll.out[]
----
...
include::{snippets-dir}/native-binaries/cunit/tests/assembleDependentComponentsReport.out[]
----
...
include::{snippets-dir}/native-binaries/cunit/tests/buildDependentComponentsReport.out[]
----
...
include::{snippets-dir}/native-binaries/cunit/tests/assembleDependentComponents.out[]
----
...
include::{snippets-dir}/native-binaries/cunit/tests/buildDependentComponents.out[]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/custom-check/groovy/build.gradle[tag=custom-check]
----
...
include::{snippets-dir}/native-binaries/custom-check/tests/nativeComponentCustomCheckOutput.out[]
----
...
----
> gradle components
include::{snippets-dir}/native-binaries/cpp/tests/nativeComponentReport.out[]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/cpp/groovy/build.gradle[tag=apply-plugin]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/custom-layout/groovy/build.gradle[tag=cpp-sources]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/c/groovy/build.gradle[tag=apply-plugin]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/custom-layout/groovy/build.gradle[tag=c-sources]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/assembler/groovy/build.gradle[tag=apply-plugin]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/objective-c/groovy/build.gradle[tag=apply-plugin]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/objective-cpp/groovy/build.gradle[tag=apply-plugin]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/cpp/groovy/build.gradle[tag=all-binaries]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/c/groovy/build.gradle[tag=all-shared-libraries]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/assembler/groovy/build.gradle[tag=assembler-args]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/cpp-lib/groovy/build.gradle[tag=args]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/windows-resources/groovy/build.gradle[tag=apply-plugin]
----
...
----
include::{snippets-dir}/native-binaries/windows-resources/groovy/build-resource-only-dll.gradle[tag=windows-resource-set]
----
...
.build-resource-only-dll.gradle
----
include::{snippets-dir}/native-binaries/windows-resources/groovy/build-resource-only-dll.gradle[tag=resource-only-library]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/cpp/groovy/build.gradle[tag=source-library]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/custom-layout/groovy/build.gradle[tag=binary-library]
----
...
.lib/build.gradle
----
include::{snippets-dir}/native-binaries/multi-project/groovy/lib/build.gradle[]
----
[source.multi-language-sample,groovy]
.exe/build.gradle
----
include::{snippets-dir}/native-binaries/multi-project/groovy/exe/build.gradle[]
----
...
----
include::{snippets-dir}/native-binaries/pre-compiled-headers/groovy/src/hello/headers/pch.h[]
----
...
----
include::{snippets-dir}/native-binaries/pre-compiled-headers/groovy/src/hello/cpp/hello.cpp[]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/pre-compiled-headers/groovy/build.gradle[tag=libraries]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/variants/groovy/build.gradle[tag=build-types]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/variants/groovy/build.gradle[tag=build-type-config]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/variants/groovy/build.gradle[tag=platforms]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/flavors/groovy/build.gradle[tag=flavors]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/variants/groovy/build.gradle[tag=target-platforms]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/tool-chains/groovy/build.gradle[tag=buildable]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/tool-chains/groovy/build.gradle[tag=toolChains]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/tool-chains/groovy/build.gradle[tag=withArguments]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/target-platforms/groovy/build.gradle[tag=targetplatforms]
----
...
.suite_operators.c
----
include::{snippets-dir}/native-binaries/cunit/groovy/src/operatorsTest/c/suite_operators.c[]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/cunit/groovy/build.gradle[tag=configure-test-binary]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/cunit/groovy/build.gradle[tag=complete-example]
----

.`gradle -q runOperatorsTestFailingCUnitExe` 的输出
----
> gradle -q runOperatorsTestFailingCUnitExe
include::{snippets-dir}/native-binaries/cunit/tests/completeCUnitExample.out[]
----
...
.build.gradle
----
include::{snippets-dir}/native-binaries/google-test/groovy/build.gradle[tag=configure-test-binary]
----
