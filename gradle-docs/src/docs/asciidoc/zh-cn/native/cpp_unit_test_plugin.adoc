...
====
include::{snippets-dir}/cpp/cppUnitTest/groovy/build.gradle[tags=apply-plugin]
include::{snippets-dir}/cpp/cppUnitTest/kotlin/build.gradle.kts[tags=apply-plugin]
====
...
====
include::{snippets-dir}/cpp/cppUnitTest/groovy/build.gradle[tags=configure-target-machines]
include::{snippets-dir}/cpp/cppUnitTest/kotlin/build.gradle.kts[tags=configure-target-machines]
====
...
image::{image-dir}/cpp-unit-test-task-graph.png[]
...
image::{image-dir}/cpp-unit-test-variant-task-graph.png[]
...
image::{image-dir}/cpp-unit-test-configurations.png[]
