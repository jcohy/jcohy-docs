...
====
include::{snippets-dir}/cpp/cppApplication/groovy/build.gradle[tags=apply-plugin]
include::{snippets-dir}/cpp/cppApplication/kotlin/build.gradle.kts[tags=apply-plugin]
====
...
====
include::{snippets-dir}/cpp/cppApplication/groovy/build.gradle[tags=configure-target-machines]
include::{snippets-dir}/cpp/cppApplication/kotlin/build.gradle.kts[tags=configure-target-machines]
====
...
image::{image-dir}/cpp-application-task-graph.png[]
...
image::{image-dir}/cpp-application-variant-task-graph.png[]
...
image::{image-dir}/cpp-application-configurations.png[]
