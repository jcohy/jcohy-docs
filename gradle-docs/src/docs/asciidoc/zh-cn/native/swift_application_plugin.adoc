...
====
include::{snippets-dir}/swift/swiftApplication/groovy/build.gradle[tags=apply-plugin]
include::{snippets-dir}/swift/swiftApplication/kotlin/build.gradle.kts[tags=apply-plugin]
====
...
====
include::{snippets-dir}/swift/swiftApplication/groovy/build.gradle[tags=configure-target-machines]
include::{snippets-dir}/swift/swiftApplication/kotlin/build.gradle.kts[tags=configure-target-machines]
====
...
image::{image-dir}/swift-application-task-graph.png[]
...
image::{image-dir}/swift-application-variant-task-graph.png[]
...
image::{image-dir}/swift-application-configurations.png[]
