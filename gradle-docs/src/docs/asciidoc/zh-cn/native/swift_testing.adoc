...
====
include::{snippets-dir}/swift/testFiltering/groovy/build.gradle[tags=test-filtering]
include::{snippets-dir}/swift/testFiltering/kotlin/build.gradle.kts[tags=test-filtering]
====
...
====
include::{snippets-dir}/swift/testReport/groovy/buildSrc/src/main/groovy/myproject.xctest-conventions.gradle[tags=test-report]
include::{snippets-dir}/swift/testReport/groovy/build.gradle[tags=test-report]
include::{snippets-dir}/swift/testReport/kotlin/buildSrc/src/main/kotlin/myproject.xctest-conventions.gradle.kts[tags=test-report]
include::{snippets-dir}/swift/testReport/kotlin/build.gradle.kts[tags=test-report]
====
