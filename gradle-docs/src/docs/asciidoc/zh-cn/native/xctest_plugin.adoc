...
====
include::{snippets-dir}/swift/swiftXCTest/groovy/build.gradle[tags=apply-plugin]
include::{snippets-dir}/swift/swiftXCTest/kotlin/build.gradle.kts[tags=apply-plugin]
====
...
====
include::{snippets-dir}/swift/swiftXCTest/groovy/build.gradle[tags=configure-target-machines]
include::{snippets-dir}/swift/swiftXCTest/kotlin/build.gradle.kts[tags=configure-target-machines]
====
...
image::{image-dir}/xctest-task-graph.png[]
...
image::{image-dir}/xctest-variant-task-graph.png[]
...
image::{image-dir}/xctest-configurations.png[]
