...
====
include::{snippets-dir}/ide/xcode/groovy/build.gradle[tags=apply-plugin]
include::{snippets-dir}/ide/xcode/kotlin/build.gradle.kts[tags=apply-plugin]
====
...
image::{image-dir}/xcode-task-graph.png[]
