...
====
include::{snippets-dir}/dependencyManagement/artifactTransforms-minify/groovy/build.gradle[tags=artifact-transform-attribute-setup]
include::{snippets-dir}/dependencyManagement/artifactTransforms-minify/kotlin/build.gradle.kts[tags=artifact-transform-attribute-setup]
====
...
include::{snippets-dir}/dependencyManagement/artifactTransforms-minify/tests/artifactTransformMinify.out[]
----
...
====
include::{snippets-dir}/dependencyManagement/artifactTransforms-unzip/groovy/build.gradle[tags=artifact-transform-unzip]
include::{snippets-dir}/dependencyManagement/artifactTransforms-unzip/kotlin/build.gradle.kts[tags=artifact-transform-unzip]
====
...
====
include::{snippets-dir}/dependencyManagement/artifactTransforms-minify/groovy/build.gradle[tags=artifact-transform-minify]
include::{snippets-dir}/dependencyManagement/artifactTransforms-minify/kotlin/build.gradle.kts[tags=artifact-transform-minify]
====
...
====
include::{snippets-dir}/dependencyManagement/artifactTransforms-relocate/groovy/build.gradle[tags=artifact-transform-relocate]
include::{snippets-dir}/dependencyManagement/artifactTransforms-relocate/kotlin/build.gradle.kts[tags=artifact-transform-relocate]
====
...
====
include::{snippets-dir}/dependencyManagement/artifactTransforms-unzip/groovy/build.gradle[tags=artifact-transform-registration]
include::{snippets-dir}/dependencyManagement/artifactTransforms-unzip/kotlin/build.gradle.kts[tags=artifact-transform-registration]
====
...
====
include::{snippets-dir}/dependencyManagement/artifactTransforms-minify/groovy/build.gradle[tags=artifact-transform-registration]
include::{snippets-dir}/dependencyManagement/artifactTransforms-minify/kotlin/build.gradle.kts[tags=artifact-transform-registration]
====
...
====
include::{snippets-dir}/dependencyManagement/artifactTransforms-incremental/groovy/build.gradle[tags=artifact-transform-countloc]
include::{snippets-dir}/dependencyManagement/artifactTransforms-incremental/kotlin/build.gradle.kts[tags=artifact-transform-countloc]
====
