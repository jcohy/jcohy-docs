...
带有 classifiers 的 Jars 还用于将库中存在多个替代方案 (例如本机代码) 与主要 artifacts 分离的部分. 例如,这是由轻量级 Java 游戏库 (LWGJ) 完成的,该库将一些特定于平台的 jar 发布到 link:https://repo1.maven.org/maven2/org/lwjgl/lwjgl/3.2.3[Maven central],
