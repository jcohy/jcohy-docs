...
====
include::sample[dir="samples/credentials-handling/publishing-credentials/groovy/build.gradle[tags=repositories]
include::sample[dir="samples/credentials-handling/publishing-credentials/kotlin/build.gradle.kts[tags=repositories]
====
