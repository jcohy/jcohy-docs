...
====
include::{snippets-dir}/signing/maven/groovy/build.gradle[tags=use-plugin]
include::{snippets-dir}/signing/maven/kotlin/build.gradle.kts[tags=use-plugin]
====
...
====
include::{snippets-dir}/signing/in-memory/groovy/build.gradle[tags=signing]
include::{snippets-dir}/signing/in-memory/kotlin/build.gradle.kts[tags=signing]
====
...
====
include::{snippets-dir}/signing/in-memory-subkey/groovy/build.gradle[tags=signing]
include::{snippets-dir}/signing/in-memory-subkey/kotlin/build.gradle.kts[tags=signing]
====
...
.Sign with GnuPG
====
include::{snippets-dir}/signing/gnupg-signatory/groovy/build.gradle[tags=configure-signatory]
include::{snippets-dir}/signing/gnupg-signatory/kotlin/build.gradle.kts[tags=configure-signatory]
====
...
.gradle.properties
----
include::{snippets-dir}/signing/gnupg-signatory/groovy/gradle.properties[tag=user-properties]
----
...
include::{snippets-dir}/signing/maven-publish/tests/signingPluginSignPublication.out[]
----
...
====
include::{snippets-dir}/signing/maven/groovy/build.gradle[tags=sign-archives]
include::{snippets-dir}/signing/maven/kotlin/build.gradle.kts[tags=sign-archives]
====
...
.**`gradle signArchives`** 的输出
----
> gradle signArchives
include::{snippets-dir}/signing/maven/tests/signingArchivesOutput.out[]
----
...
====
include::{snippets-dir}/signing/tasks/groovy/build.gradle[tags=sign-task]
include::{snippets-dir}/signing/tasks/kotlin/build.gradle.kts[tags=sign-task]
====
...
----
> gradle signStuffZip
include::{snippets-dir}/signing/tasks/tests/signingTaskOutput.out[]
----
...
====
include::{snippets-dir}/signing/conditional/groovy/build.gradle[tags=conditional-signing]
include::{snippets-dir}/signing/conditional/kotlin/build.gradle.kts[tags=conditional-signing]
====
...
====
include::{snippets-dir}/signing/conditional/groovy/build.gradle[tags=only-if]
include::{snippets-dir}/signing/conditional/kotlin/build.gradle.kts[tags=only-if]
====
...
====
include::{snippets-dir}/signing/maven/groovy/build.gradle[tags=sign-pom]
include::{snippets-dir}/signing/maven/kotlin/build.gradle.kts[tags=sign-pom]
====
