...
====
include::{snippets-dir}/toolingApi/runBuild/groovy/build.gradle[tags=use-tooling-api]
include::{snippets-dir}/toolingApi/runBuild/kotlin/build.gradle.kts[tags=use-tooling-api]
====
