...
.Simple Task Graph
image::{image-dir}/commandLineTutorialTasks.png[]

.Excluding tasks
----
$ gradle dist --exclude-task test
include::{snippets-dir}/tutorial/excludeTasks/tests/excludeTask.out[]
----
...
----
$ gradle  mAL:cT
include::{snippets-dir}/tutorial/nameMatching/tests/nameMatching.out[]
----
...
include::{snippets-dir}/tutorial/projectReports/tests/taskHelp.out[]
----
...
image::{image-dir}/gradle-core-test-build-scan-dependencies.png[Build Scan dependencies report]
...
include::{snippets-dir}/tutorial/projectReports/tests/propertyListReport.out[]
----
...
.Gradle Completion
image::{image-dir}/gradle-completion-4.0.gif[]
...
image::{image-dir}/gradle-core-test-build-scan-performance.png[Build Scan performance report]
...
image::{image-dir}/rich-cli.png[alt="Gradle Rich Console"]
