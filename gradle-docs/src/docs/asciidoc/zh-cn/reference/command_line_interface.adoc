...
.Simple Task Graph
image::images/commandLineTutorialTasks.png[]
...
image::images/gradle-core-test-build-scan-dependencies.png[Build Scan dependencies report]
...
.Gradle Completion
image::images/gradle-completion-4.0.gif[]
...
image::images/gradle-core-test-build-scan-performance.png[Build Scan performance report]
...
image::images/rich-cli.png[alt="Gradle Rich Console"]
