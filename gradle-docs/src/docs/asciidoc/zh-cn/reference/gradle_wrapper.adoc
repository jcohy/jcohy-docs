...
image::{image-dir}/wrapper-workflow.png[]
...
----
$ gradle wrapper
include::{snippets-dir}/wrapper/simple/tests/wrapperCommandLine.out[]
----
...
----
$ gradlew.bat build
include::{snippets-dir}/wrapper/simple/tests/wrapperBatchFileExecution.out[]
----
...
include::{snippets-dir}/wrapper/simple/tests/wrapperGradleVersionUpgrade.out[]
----
...
====
include::{snippets-dir}/wrapper/customized-task/groovy/build.gradle[tags=customized-wrapper-task]
include::{snippets-dir}/wrapper/customized-task/kotlin/build.gradle.kts[tags=customized-wrapper-task]
====
