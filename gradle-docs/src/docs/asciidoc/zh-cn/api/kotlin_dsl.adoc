...
+
image::{image-dir}/intellij-build-import-popup.png[IntelliJ IDEA, width=300]
+
image::{image-dir}/android-studio-build-sync-popup.png[IntelliJ IDEA]
 2. Reload script dependencies when editing a build script
+
image::{image-dir}/intellij-script-dependencies-reload.png[Reload script dependencies]
...
====
include::{snippets-dir}/kotlinDsl/accessors/kotlin/build.gradle.kts[tags=accessors]
====
...
====
include::{snippets-dir}/kotlinDsl/noAccessors/kotlin/build.gradle.kts[tags=no-accessors]
====
...
.Artifact configurations
====
include::{snippets-dir}/kotlinDsl/noAccessors/kotlin/build.gradle.kts[tags=dependencies]
====
...
.Project extensions and conventions
====
include::{snippets-dir}/kotlinDsl/noAccessors/kotlin/build.gradle.kts[tags=project-extension]
====
...
====
include::{snippets-dir}/kotlinDsl/noAccessors/kotlin/build.gradle.kts[tags=project-container-extension]
====
...
.Tasks
====
include::{snippets-dir}/kotlinDsl/noAccessors/kotlin/build.gradle.kts[tags=tasks]
====
...
====
include::{snippets-dir}/kotlinDsl/sourceSetConvention/kotlin/build.gradle.kts[tags=source-set-convention]
====
...
====
include::{snippets-dir}/kotlinDsl/multiProjectBuild/kotlin/settings.gradle.kts[tags=base]
include::{snippets-dir}/kotlinDsl/multiProjectBuild/kotlin/build.gradle.kts[tags=root
include::{snippets-dir}/kotlinDsl/multiProjectBuild/kotlin/domain/build.gradle.kts[]
include::{snippets-dir}/kotlinDsl/multiProjectBuild/kotlin/infra/build.gradle.kts[]
include::{snippets-dir}/kotlinDsl/multiProjectBuild/kotlin/http/build.gradle.kts[]
====
...
====
include::{snippets-dir}/kotlinDsl/multiProjectBuild/kotlin/settings.gradle.kts[tags=repositories]
====
...
====
include::{snippets-dir}/kotlinDsl/androidBuild/kotlin/settings.gradle.kts[tags=android]
include::{snippets-dir}/kotlinDsl/androidBuild/kotlin/build.gradle.kts[tags=android-buildscript]
include::{snippets-dir}/kotlinDsl/androidBuild/kotlin/lib/build.gradle.kts[tags=android]
include::{snippets-dir}/kotlinDsl/androidBuild/kotlin/app/build.gradle.kts[tags=android]
====
...
====
include::{snippets-dir}/kotlinDsl/multiProjectBuild/kotlin/settings.gradle.kts[tags=base]
include::{snippets-dir}/kotlinDsl/multiProjectBuild/kotlin/build.gradle.kts[tags=cross]
====
...
====
include::{snippets-dir}/kotlinDsl/androidSingleBuild/kotlin/settings.gradle.kts[tags=android]
include::{snippets-dir}/kotlinDsl/androidSingleBuild/kotlin/build.gradle.kts[tags=android]
====
...
.Using the container API
====
include::{snippets-dir}/kotlinDsl/containers-api/kotlin/build.gradle.kts[tags=api]
====
...
.Using Kotlin delegated properties
====
include::{snippets-dir}/kotlinDsl/containers-delegated-properties/kotlin/build.gradle.kts[tags=delegated-properties]
====
...
.Container scope
====
include::{snippets-dir}/kotlinDsl/containers-scope/kotlin/build.gradle.kts[tags=scope]
====
...
// .The container scope string invoke extension
// ====
// include::{snippets-dir}/kotlinDsl/containers-string-invoke/kotlin/build.gradle.kts[tags=string-invoke]
// ====
...
====
include::{snippets-dir}/kotlinDsl/kotlinDslPlugin/kotlin/buildSrc/build.gradle.kts[tags=apply]
====
...
====
include::{snippets-dir}/kotlinDsl/kotlinDslPlugin/kotlin/buildSrc/build.gradle.kts[tags=disable-experimental-warning]
====
...
====
include::{snippets-dir}/kotlinDsl/interoperability-static-extensions/kotlin/build.gradle[tags=kotlin-from-groovy]
====
...
====
include::{snippets-dir}/kotlinDsl/interoperability-static-extensions/kotlin/build.gradle.kts[tags=groovy-from-kotlin]
====
...
.Use `closureOf<T> {}`
====
include::{snippets-dir}/kotlinDsl/interoperability-closure-of/kotlin/build.gradle.kts[tags=closureOf]
====
...
====
include::{snippets-dir}/kotlinDsl/interoperability-delegate-closure-of/kotlin/build.gradle.kts[tags=delegateClosureOf]
====
...
====
include::{snippets-dir}/kotlinDsl/interoperability-kotlinClosure/kotlin/build.gradle.kts[tags=kotlinClosure]
====
...
====
include::{snippets-dir}/kotlinDsl/interoperability-groovy-builder/kotlin/build.gradle.kts[tags=withGroovyBuilder]
====
