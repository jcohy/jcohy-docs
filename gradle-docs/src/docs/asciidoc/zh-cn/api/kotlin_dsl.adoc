...
====
include::{snippets-dir}/kotlinDsl/multiProjectBuild/kotlin/settings.gradle.kts[tags=base];build.gradle.kts[tags=root];domain/build.gradle.kts[];infra/build.gradle.kts[];http/build.gradle.kts[]
====
...
====
include::{snippets-dir}/kotlinDsl/androidBuild/kotlin/settings.gradle.kts[tags=android];build.gradle.kts[tags=android-buildscript];lib/build.gradle.kts[tags=android];app/build.gradle.kts[tags=android]
====
...
.Cross-configuring projects
====
include::{snippets-dir}/kotlinDsl/multiProjectBuild/kotlin/settings.gradle.kts[tags=base];build.gradle.kts[tags=cross]
====
...
====
include::{snippets-dir}/kotlinDsl/androidSingleBuild/kotlin/settings.gradle.kts[tags=android];build.gradle.kts[tags=android]
====
