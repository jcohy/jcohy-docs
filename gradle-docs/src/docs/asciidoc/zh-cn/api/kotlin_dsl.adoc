...
+
image::images/intellij-build-import-popup.png[IntelliJ IDEA, width=300]
+
image::images/android-studio-build-sync-popup.png[IntelliJ IDEA]
 2. Reload script dependencies when editing a build script
+
image::images/intellij-script-dependencies-reload.png[Reload script dependencies]
