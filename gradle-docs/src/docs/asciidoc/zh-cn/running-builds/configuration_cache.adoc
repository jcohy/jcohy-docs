...
image::{image-dir}/configuration-cache/running-help.gif[]
...
include::{snippets-dir}/configurationCache/noProblem/tests/store.out[]
...
...
----
❯ gradle --configuration-cache help
include::{snippets-dir}/configurationCache/noProblem/tests/load.out[]
...
...
a|
[horizontal]
link:{gradle-issues}13455[[.green]#✓#]:: <<application_plugin.adoc#application_plugin,Application>>
link:{gradle-issues}13455[[.green]#✓#]:: <<war_plugin.adoc#war_plugin,WAR>>
link:{gradle-issues}13455[[.green]#✓#]:: <<ear_plugin.adoc#ear_plugin,EAR>>
...
link:{gradle-issues}13455[[.green]#✓#]:: <<distribution_plugin.adoc#distribution_plugin,Distribution>>
...
link:{gradle-issues}13455[[.green]#✓#]:: <<java_gradle_plugin.adoc#java_gradle_plugin,Java Plugin Development>>
link:{gradle-issues}13472[[.red]#✖#]:: <<custom_plugins.adoc#sec:precompiled_plugins,Groovy DSL Plugin Development>>
...
====
include::{snippets-dir}/configurationCache/problemsGroovy/groovy/build.gradle[]
include::{snippets-dir}/configurationCache/problemsKotlin/kotlin/build.gradle.kts[]
====
...
...
include::{snippets-dir}/configurationCache/problemsGroovy/tests/fail.out[]
...
image::{image-dir}/configuration-cache/problems-report.png[]
...
include::{snippets-dir}/configurationCache/problemsGroovy/tests/store.out[]
Configuration cache entry stored with 2 problems.
❯ gradle --configuration-cache --configuration-cache-problems=warn someTask -DsomeDestination=dest
include::{snippets-dir}/configurationCache/problemsGroovy/tests/load.out[]
...
====
include::{snippets-dir}/configurationCache/problemsFixed/groovy/build.gradle[tags=fixed]
include::{snippets-dir}/configurationCache/problemsFixed/kotlin/build.gradle.kts[tags=fixed]
====
...
----
❯ gradle --configuration-cache someTask -DsomeDestination=dest
include::{snippets-dir}/configurationCache/problemsFixed/tests/store.out[]
Configuration cache entry stored.
❯ gradle --configuration-cache someTask -DsomeDestination=dest
include::{snippets-dir}/configurationCache/problemsFixed/tests/load.out[]
Configuration cache entry reused.
----
...
include::{snippets-dir}/configurationCache/problemsFixed/tests/store-another.out[]
Configuration cache entry stored.
----
...
====
include::{snippets-dir}/configurationCache/problemsFixedReuse/groovy/build.gradle[tags=fixed-reuse]
include::{snippets-dir}/configurationCache/problemsFixedReuse/kotlin/build.gradle.kts[tags=fixed-reuse]
====
...
----
❯ gradle --configuration-cache someTask -DsomeDestination=dest
include::{snippets-dir}/configurationCache/problemsFixedReuse/tests/store.out[]
Configuration cache entry stored.
❯ gradle --configuration-cache someTask -DsomeDestination=another
include::{snippets-dir}/configurationCache/problemsFixedReuse/tests/load-another.out[]
Configuration cache entry reused.
----
...
====
include::{snippets-dir}/configurationCache/testKit/groovy/src/test/groovy/org/example/BuildLogicFunctionalTest.groovy[tags=functional-test-configuration-cache]
include::{snippets-dir}/configurationCache/testKit/kotlin/src/test/kotlin/org/example/BuildLogicFunctionalTest.kt[tags=functional-test-configuration-cache]
====
...
====
include::{snippets-dir}/configurationCache/disallowedTypes/groovy/build.gradle[tags=task-type]
include::{snippets-dir}/configurationCache/disallowedTypes/kotlin/build.gradle.kts[tags=task-type]
====
...
====
include::{snippets-dir}/configurationCache/disallowedTypesFixed/groovy/build.gradle[tags=task-type]
include::{snippets-dir}/configurationCache/disallowedTypesFixed/kotlin/build.gradle.kts[tags=task-type]
====
...
====
include::{snippets-dir}/configurationCache/disallowedTypes/groovy/build.gradle[tags=ad-hoc-task]
include::{snippets-dir}/configurationCache/disallowedTypes/kotlin/build.gradle.kts[tags=ad-hoc-task]
====
...
====
include::{snippets-dir}/configurationCache/disallowedTypesFixed/groovy/build.gradle[tags=ad-hoc-task]
include::{snippets-dir}/configurationCache/disallowedTypesFixed/kotlin/build.gradle.kts[tags=ad-hoc-task]
====
...
====
include::{snippets-dir}/configurationCache/projectAtExecution/groovy/build.gradle[tags=task-type]
include::{snippets-dir}/configurationCache/projectAtExecution/kotlin/build.gradle.kts[tags=task-type]
====
...
====
include::{snippets-dir}/configurationCache/projectAtExecutionFixed/groovy/build.gradle[tags=task-type]
include::{snippets-dir}/configurationCache/projectAtExecutionFixed/kotlin/build.gradle.kts[tags=task-type]
====
...
====
include::{snippets-dir}/configurationCache/projectAtExecution/groovy/build.gradle[tags=ad-hoc-task]
include::{snippets-dir}/configurationCache/projectAtExecution/kotlin/build.gradle.kts[tags=ad-hoc-task]
====
<1> this will be reported as a problem because the task action is using the `Project` object at execution time
...
====
include::{snippets-dir}/configurationCache/projectAtExecutionFixed/groovy/build.gradle[tags=ad-hoc-task]
include::{snippets-dir}/configurationCache/projectAtExecutionFixed/kotlin/build.gradle.kts[tags=ad-hoc-task]
====
...
====
include::{snippets-dir}/valueProviders/gradlePropsDont/groovy/build.gradle[]
include::{snippets-dir}/valueProviders/gradlePropsDont/kotlin/build.gradle.kts[]
====
...
====
include::{snippets-dir}/valueProviders/gradlePropsDo/groovy/build.gradle[]
include::{snippets-dir}/valueProviders/gradlePropsDo/kotlin/build.gradle.kts[]
====
...
====
include::{snippets-dir}/valueProviders/sysPropsDont/groovy/build.gradle[]
include::{snippets-dir}/valueProviders/sysPropsDont/kotlin/build.gradle.kts[]
====
...
====
include::{snippets-dir}/valueProviders/sysPropsDo/groovy/build.gradle[]
include::{snippets-dir}/valueProviders/sysPropsDo/kotlin/build.gradle.kts[]
====
...
====
include::{snippets-dir}/valueProviders/envVarsDont/groovy/build.gradle[]
include::{snippets-dir}/valueProviders/envVarsDont/kotlin/build.gradle.kts[]
====
...
====
include::{snippets-dir}/valueProviders/envVarsDo/groovy/build.gradle[]
include::{snippets-dir}/valueProviders/envVarsDo/kotlin/build.gradle.kts[]
====
...
====
include::{snippets-dir}/valueProviders/fileContentsDont/groovy/build.gradle[]
include::{snippets-dir}/valueProviders/fileContentsDont/kotlin/build.gradle.kts[]
====
...
====
include::{snippets-dir}/valueProviders/fileContentsDo/groovy/build.gradle[]
include::{snippets-dir}/valueProviders/fileContentsDo/kotlin/build.gradle.kts[]
====
...
Build scan functionality with configuration caching enabled requires Gradle Enterprise plugin version 3.4 or later.
When using an earlier version, build scan publishing will be automatically disabled when configuration caching is used.
...
[[config_cache:not_yet_implemented:normalization]]
=== Custom input normalization

Custom <<more_about_tasks#sec:configure_input_normalization, input normalization>> is not captured when using the configuration cache.
...
See link:{gradle-issues}13706[gradle/gradle#13706].
