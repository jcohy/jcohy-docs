...
----
include::{spring-data-rest-root}/test/java/org/springframework/data/rest/webmvc/support/ETagUnitTests.java[tag=versioned-sample]
----
...
[source,java]
----
include::{spring-data-rest-root}/main/java/org/springframework/data/rest/tests/mongodb/Receipt.java[tag=code]
----
