...
有关更多信息,请参见 Spring Framework 文档中的 https://docs.spring.io/spring/docs/{spring-framework-version}/spring-framework-reference/data-access.html#orm-exception-translation[特定部分] .
