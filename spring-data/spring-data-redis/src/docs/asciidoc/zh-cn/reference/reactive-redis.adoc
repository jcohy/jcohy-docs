...
Spring Data Redis当前与 https://github.com/lettuce-io/lettuce-core[Lettuce] 集成为唯一的响应式 Java 连接器. https://projectreactor.io/[Project Reactor] 用作响应式库.
...
通过响应式基础架构执行 Redis 脚本可以使用通过 `ReactiveRedisTemplate` 最佳访问的 `ReactiveScriptExecutor` 来完成.
