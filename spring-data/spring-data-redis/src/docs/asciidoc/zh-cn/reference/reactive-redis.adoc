...
有关更多信息,请参见Spring Framework文档中的 https://docs.spring.io/spring/docs/{springVersion}/spring-framework-reference/data-access.html#orm-exception-translation[特定部分] .
