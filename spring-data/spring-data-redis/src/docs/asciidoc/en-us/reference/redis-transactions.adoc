...
----
<1> Configures a Spring Context to enable https://docs.spring.io/spring/docs/{spring-framework-version}/spring-framework-reference/data-access.html#transaction-declarative[declarative transaction management].
