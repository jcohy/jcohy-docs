...
* `BeanUtilsHashMapper` using Spring's https://docs.spring.io/spring/docs/{spring-framework-version}/javadoc-api/org/springframework/beans/BeanUtils.html[BeanUtils].
