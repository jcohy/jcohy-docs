...
:leveloffset: +1
include::{spring-data-commons}/repositories.adoc[]
include::{spring-data-commons}/repository-projections.adoc[leveloffset=+1]
:leveloffset: -1
...
include::{spring-data-commons}/entity-callbacks.adoc[]
...
include::{spring-data-commons}/repository-populator-namespace-reference.adoc[]
include::{spring-data-commons}/repository-query-keywords-reference.adoc[]
include::{spring-data-commons}/repository-query-return-types-reference.adoc[]
