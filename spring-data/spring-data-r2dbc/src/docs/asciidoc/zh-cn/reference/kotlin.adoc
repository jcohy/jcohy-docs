include::{spring-data-commons}/kotlin.adoc[]

include::{spring-data-commons}/kotlin-extensions.adoc[leveloffset=+1]
...
include::{spring-data-commons}/kotlin-coroutines.adoc[leveloffset=+1]
