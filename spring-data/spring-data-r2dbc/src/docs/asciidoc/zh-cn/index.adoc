...
:spring-framework-ref: https://docs.spring.io/spring/docs/{spring-framework-version}/reference/html
:reactiveStreamsJavadoc: https://www.reactive-streams.org/reactive-streams-{reactive-stream-version}-javadoc
