...
[[xsd-schemas-dataaccess]]
== XML Schemas

附录的这一部分列出了用于数据访问的 XML schema,包括以下内容:

* <<xsd-schemas-dataaccess-tx,tx schemas>>
* <<xsd-schemas-dataaccess-jdbc,jdbc schemas>>

[[xsd-schemas-dataaccess-tx]]
=== `tx` Schema
