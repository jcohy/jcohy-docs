...
通过利用 `kotlin-script-runtime` 和 `scripting-jsr223-embedded` 的依赖,可以使用此类功能来使用 https://github.com/Kotlin/kotlinx.html[kotlinx.html] DSL或Kotlin多行插值 `String` 渲染基于Kotlin的模板.
