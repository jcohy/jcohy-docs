...
[[xsd-schemas-integration]]
== XML Schemas

附录的这一部分列出了与集成技术相关的 XML Schemas.

[[xsd-schemas-integration-jee]]
=== `jee` Schema
...
[[xsd-schemas-integration-jee-jndi-lookup]]
...
[[xsd-schemas-integration-jee-jndi-lookup-environment-single]]
...
[[xsd-schemas-integration-jee-jndi-lookup-evironment-multiple]]
...
[[xsd-schemas-integration-jee-jndi-lookup-complex]]
==== `<jee:jndi-lookup/>` (复杂)
...
[[xsd-schemas-integration-jee-local-slsb]]
==== `<jee:local-slsb/>` (简单)
...
[[xsd-schemas-integration-jee-local-slsb-complex]]
==== `<jee:local-slsb/>` (复杂)
...
[[xsd-schemas-integration-jee-remote-slsb]]
==== <jee:remote-slsb/>
...
[[xsd-schemas-integration-context-mbe]]
