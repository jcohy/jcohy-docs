...
对于操作方法问题或诊断或调试问题,我们建议使用 Stackoverflow. Spring 在此网站上有一个专用的页面 https://stackoverflow.com/questions/tagged/spring+or+spring-mvc+or+spring-aop[questions page]  ,列出了建议使用的标记.  如果你相当确定 Spring 框架存在问题,或者想建议添加功能等等,可以使用 https://github.com/spring-projects/spring-framework/issues[GitHub Issues].
