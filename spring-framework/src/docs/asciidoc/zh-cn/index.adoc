...
v{spring-framework-version}
include::attributes.adoc[]

本文档包含 https://docs.jcohy.com/docs/spring-framework/{spring-framework-version}/html5/zh-cn/index.html[一个多页面] 和 https://docs.jcohy.com/docs/spring-framework/{spring-framework-version}/pdf/zh-cn/index.pdf[一个 PDF].
...
最新特性，更新日志，支持的版本, 和其他跨版本的信息都在 https://github.com/spring-projects/spring-framework/wiki[*Github Wiki*] 进行维护。
